                                                ...
                                                <tr key={i}>
                                                    ...
                                                    <td className="flex items-center justify-center gap-2">
                                                        <div className="w-[30px] relative h-[30px] rounded-full bg-[#8BC5E5] ">
                                                            <span className="absolute top-1/2 right-1/2 transform -translate-y-1/2 translate-x-1/2 text-white poppins font-medium text-base">{i + 1}</span>
                                                        </div>
                                                        <span className="inter text-sm font-medium">{lead.listName}</span>
                                                    </td>
                                                    <td>
                                                        <div className="flex items-center justify-center gap-2">
                                                            <MapMarker /><span className="text-center inter text-sm font-medium ">{lead.state}</span>
                                                        </div>
                                                    </td>
                                                    <td><p className="text-center inter text-sm font-medium ">{lead.emailTemplate}</p></td>
                                                </tr>
                                            )
                                        })
                                    }
